...
import { Loader2, CheckCircle2, AlertTriangle, Search, ArrowRight } from "lucide-react";
...
export default function CompleteProfilePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const returnTo = savedReturnTo && savedReturnTo.startsWith("/") && !savedReturnTo.startsWith("//") && !savedReturnTo.match(/^https?:\/\//) ? savedReturnTo : "/app";
  ...
  return (
    <AuthLayout
      ...
      subheadline="One more step to enter MVP Draft"
      features={[
        "Connect your MLBB account",
        "Verify your in-game identity",
        "Start using MVP Draft features",
      ]}
    >
      <div className="w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-400 mt-2">
            One more step before entering MVP Draft
          </p>
        </div>

        {user && (
          <div className="flex items-center gap-3 rounded-xl border border-white/[0.06] bg-white/[0.02] p-3 mb-5">
            {user.avatar_url && (
              <img
                src={user.avatar_url}
                alt="Google avatar"
