...
export default function LoginPage() {
  ...
  return (
    <AuthLayout
      headline="Build Better Drafts"
      subheadline="Your Command Center"
      features={[
        "Draft analytics & hero intelligence",
        "Team strategy & macro planning",
        "MLBB competitive data hub",
      ]}
    >
      <div className="w-full">
        <div className="text-center mb-8">
          ...
          >
            Sign in to MVP Draft
          </h1>
          <p className="text-sm text-slate-400 mt-2">
            Access your draft war room and analytics
          </p>
        </div>
