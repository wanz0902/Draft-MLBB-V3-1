...
export default function HeroCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`group relative h-56 md:h-64 flex flex-col cursor-pointer overflow-hidden clip-angular border transition-all duration-300 hover:-translate-y-2 hover:shadow-xl
        ${isSelected
          ? "border-amber-500/50"
